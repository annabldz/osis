                ...
                <hr class="horizontal gray-light my-1">
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm">
                        <strong class="text-dark">Foto Web:</strong> &nbsp; <img src="<?= base_url('img/'.$mey->foto);?>" class="w-45 border-radius-lg shadow-sm">
                        </li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm">
                  ...
                  <div class="col d-flex align-items-end" class="form-control">
                      <a href="<?= base_url('home/editweb/'.$mey->id)?>" class="btn btn-primary"
