...
<head>
  ...
  <link rel="icon" type="image/png" href="<?=base_url ('img/osis.png')?>">
  <title>
    Manajemen OSIS
  </title>
  <!--     Fonts and icons     -->
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-dark border-radius-lg py-1 pe-0">
                  <h4 class="text-white font-weight-bolder text-center mt-5 mb-0">APLIKASI OSIS</h4>
              ...
              <?php endif; ?>
                <form id="login-form" role="form" class="text-start" action="<?= base_url('home/aksi_login')?>" method="post" class="row g-3 needs-validation" novalidate>
                  ...
                  <div class="text-center">
                    <a href="/home/lupa_password" class="text-secondary text-sm">
                      Lupa Password?
                    </a>
                  </div>
