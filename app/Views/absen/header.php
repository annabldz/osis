...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= base_url('assets/img/'.$mey->foto);?>">
  <title>
  <?= $mey->nama?>
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href="">
        <img src="<?= base_url('assets/img/'.$mey->foto);?>" class="navbar-brand-img" width="26" height="26" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-dark" href="/absen/dashboard">
        ...
        <li class="nav-item">
        <a class="nav-link  text-dark" href="/absen/absensi">
        <i class="material-symbols-rounded opacity-5">qr_code_scanner</i>
            <span class="nav-link-text ms-1">Scan Absensi</span>
          </a>
        </li>
        <?php } ?>
        <?php
        ...
        <li class="nav-item">
        <a class="nav-link  text-dark" href="/absen/absensi2">
        <i class="material-symbols-rounded opacity-5">qr_code_scanner</i>
            <span class="nav-link-text ms-1">Scan Absensi</span>
          </a>
        </li>
        ...
        <?php
          if (session()->get('level')==3   ){ ?>
        <li class="nav-item">
        <a class="nav-link  text-dark" href="/absen/kartusiswa">
        <i class="material-symbols-rounded opacity-5">qr_code_scanner</i>
            <span class="nav-link-text ms-1">Kartu Pelajar</span>
          </a>
        </li>
        <?php } ?>
        <?php
          if (session()->get('level')==2 ){ ?>
        <li class="nav-item">
        <a class="nav-link  text-dark" href="/absen/kartuguru">
        <i class="material-symbols-rounded opacity-5">qr_code_scanner</i>
            <span class="nav-link-text ms-1">Kartu Pengajar</span>
          </a>
        </li>
        <?php } ?>
        <?php
        ...
        <li class="nav-item">
        <a class="nav-link  text-dark" href="/absen/activity">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="/absen/absenguru">
            <i class="material-symbols-rounded opacity-5">insert_chart</i>
            <span class="nav-link-text ms-1">History Absensi</span>
          </a>
        </li>
        <?php } ?>
        <?php
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="/absen/web">
        ...
        <?php } ?>
        <li class="nav-item">
          <a class="nav-link text-dark" href="/absen/profile">
