      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h3 class="card-title">Input Data Kelas</h5>

    <form action="/absen/saveikelas" method="POST" enctype="multipart/form-data">
        <div class="input-group input-group-static mb-4">
          <label>Nama Kelas:</label>
          <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Kelas:" name="nama" value="<?= $anjas->nama_kelas ?>">
        </div>
        <div class="input-group input-group-static mb-4">
          <label>Wali Kelas:</label>
          <select class="form-control" name="walkel">
