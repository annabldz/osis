	...
	protected function beforeDelete(array $data)
{
	...
	// app/Models/AbsensiSiswaModel.php

// public function tampiluser()
// {
//     	return $this->select('user.*, user.nama_user')
// 					->join('user AS creator', 'creator.id_user = user.created_by', 'left')
// 					->where('user.kondisi', 0)
// 					->findAll();
// }
// app/Models/UserModel.php

public function getUsersWithCreator()
{
    return $this->select('user.*, creator.nama_user AS pembuat')
                ->join('user AS creator', 'creator.id_user = users.created_by', 'left')
                ->findAll();
}
